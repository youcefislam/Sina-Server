...
-- wilaya
INSERT INTO
    `sinaV1`.`wilaya`(`idWilaya`, `nomWilaya`)
VALUES
    (1, "wilaya 1"),
    (2, "wilaya 2"),
    (3, "wilaya 3"),
...
-- daira
INSERT INTO
    `sinaV1`.`daira`(`idDaira`, `nomDaira`, `idWilaya`)
VALUES
    (1, "Daira 1", 1),
    (2, "Daira 2", 1),
    (3, "Daira 3", 1),
...
-- commune
INSERT INTO
    `sinaV1`.`commune`(`idCommune`, `nomCommune`, `idDaira`)
VALUES
    (1, "commune 1", 1),
    (2, "commune 2", 2),
    (3, "commune 3", 3),
...
-- Medicament
INSERT INTO
    `sinaV1`.`medicament`(`idMedicament`, `nomMedicament`)
VALUES
    (1, "Medicament 1"),
    (2, "Medicament 2"),
    (3, "Medicament 3"),
